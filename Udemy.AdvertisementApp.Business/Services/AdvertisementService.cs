...
namespace Udemy.AdvertisementApp.Business.Services
{
    public class AdvertisementService : Service<AdvertisementCreateDto, AdvertisementUpdateDto, AdvertisementListDto, Advertisement>, IAdvertisementService
    {
        ...
        public AdvertisementService(IMapper mapper, IValidator<AdvertisementCreateDto> createDto, IValidator<AdvertisementUpdateDto> updateDto, IUow uow) : base(mapper,createDto,updateDto,uow)
        {
            _uow = uow;
            _mapper = mapper;
        }
